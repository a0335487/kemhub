...
<? include "../../app/include/sidebar-admin.php";?>
            <div class="posts col-9">
                ...
                <div class="mb-12 col-12 col-md-12 err">
                    ...
                    <form action="created.php" method="post" class="row g-3">
                        <div class="col-md-6 mb-4">
                            <input name="name" value="<?=$name?>" type="text" class="form-control form-post" placeholder="Имя" aria-label="First name">
                        </div>
                        <div class="col-md-6 mb-4">
                            <input name="surname" value="<?=$surname?>" type="text" class="form-control form-post" placeholder="Фамилия" aria-label="Last name">
                        </div>
                        <div class="col-12 mb-4">
                            <input name="mail" value="<?=$email?>" type="email" placeholder="Email" class="form-control form-post" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="col-md-6">
                            <input name="password_1" type="password" placeholder="Пароль" class="form-control form-post" id="exampleInputPassword1">
                        </div>
                        <div class="col-md-6">
