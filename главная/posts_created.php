...
<? include "app/include/sidebar-user.php";?>
            ...
            <div class="button row">
                ...
                <div class="mb-12 col-12 col-md-12 err">
                    ...
                    <form action="posts_created.php" method="post" enctype="multipart/form-data">
                        <div class="col mb-4">
                        ...
                        <div class="col mb-4">
                            ...
                            <textarea name="content" class="form-control form-post" id="editor" rows="6"><?=$content;?></textarea>
                        </div>
                        ...
                        <select id="topics" name="topic" class="form-select form-post mb-2" aria-label="Default select example">
